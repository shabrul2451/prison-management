<?php
   ...
   $sql = "SELECT prisoner_id,first_name,section_name,case_type,case_year,status from prisoner  WHERE status = 'in'";
          ...
          <img class="logo" src="resources/img/logo2.png" width="100" alt="image" height="70">
            <div class="lining">
               <ul b class="navUl">
                  ...
                  <li class="navLi"><a href="addPrisoner.php"> Add Prisoner</a></li>
